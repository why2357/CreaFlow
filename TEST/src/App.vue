  ...
  <div class="container">
    ...
    <div class="upload-section">
      <label for="file-input" class="upload-btn">
        <span>+ 上传图片</span>
        <input id="file-input" type="file" accept="image/*" multiple @change="handleFileChange" />
      </label>
        ...
        <div class="images-grid">
          <div v-for="img in imgs" :key="img.id" class="image-card">
            ...
            <div class="image-info">
              <select
                :value="img.category"
                @change="updateCategory(img.id, ($event.target as HTMLSelectElement).value)"
              >
    ...
    <div class="input-section">
      ...
      <div v-if="showMentionMenu && images.length > 0" class="mention-menu">
        ...
        <div v-for="img in images" :key="img.id" class="mention-item" @click="mentionImage(img.id)">
